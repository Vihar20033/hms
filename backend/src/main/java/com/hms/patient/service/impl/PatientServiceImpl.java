...
public class PatientServiceImpl implements PatientService {
    ...
    public PatientOnboardingResponseDTO create(PatientRequestDTO dto) {
        ...
        auditLogService.log(getCurrentUsername(), "PATIENT_CREATE", "Patient", saved.getId().toString(),
                "name=" + saved.getName());
    ...
    public Slice<PatientResponseDTO> search(
            String name,
            String email,
            String bloodGroup,
            String urgencyLevel,
        ...
        Specification<Patient> spec = Specification
                .where(PatientSpecification.notDeleted())
        ...
        return slice.map(patient -> mapper.toResponse(patient));
    }
    ...
    public PatientResponseDTO update(UUID id, PatientRequestDTO dto) {
        ...
        auditLogService.log(getCurrentUsername(), "PATIENT_UPDATE", "Patient", id.toString(),
    ...
    public void delete(UUID id) {
        ...
        auditLogService.log(getCurrentUsername(), "PATIENT_DELETE", "Patient", id.toString(),
